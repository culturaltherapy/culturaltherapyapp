...
import { tribes, tribeRequests } from "@/lib/mock-data";
  ...
  return (
    <div>
        ...
        <div className="flex items-end justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-ink2 mt-2 max-w-prose">
              Each Tribe has its own Village — a private text forum and audio
              room. Like Facebook groups, but kept small on purpose. We cap
              suggested Tribe size at 30.
            </p>
          </div>
      ...
      <section className="mt-10">
        <h2 className="font-display text-2xl">Your Tribes ({tribes.length})</h2>
            ...
            <li key={t.id}>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="mt-1 text-sm opacity-90">{t.memberCount} members</p>
                </div>
                <div className="relative">
